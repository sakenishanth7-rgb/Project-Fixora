...
Preserve structure and emphasis.`,
      ...
      case "transcribe": {
        ...
        const transcribeData = await callGateway({
          ...
          messages: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "Transcribe the spoken words in this audio. Return ONLY the transcribed text, nothing else. No quotes, no labels, no formatting.",
                },
                {
                  type: "image_url",
                  image_url: {
        ...
        return jsonResponse({ result: transcript.trim() });
      }
